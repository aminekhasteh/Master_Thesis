...
# 0.4689  0.5085  0.5207  0.5251  0.5331  0.8305
...
summary(l1)
# Min.    1st Qu. Median  Mean    3rd Qu. Max. 
# 0.1022  0.2149  0.2218  0.2217  0.2282  0.3193  
...
map_dbl(m, ac)
# Euclidean: 0.14596812 0.09869698 0.34977840 0.52274990
...
map_dbl(m, ac)
# Correlation: 0.11610691 0.07495012 0.50639862 0.57040443
...
jpeg("/Users/Shadow/OneDrive/Documents/Current Jobs/Masters Thesis/Code/Master_Thesis/Plots/Heatmaps/Heatmap_Pheno_Meta-PRS_top6_new_complete.jpg",
...
for (pcnum in 1:20){
        ...
        ggplot(pc_top20, aes(x=reorder(phenotypes, Contribution), y=Contribution)) +
                        ...
                        coord_flip()
        ggsave(paste("/Users/Shadow/OneDrive/Documents/Current Jobs/Masters Thesis/Code/Master_Thesis/Plots/PCA/",
                     "META_top6Pvals_PC",pcnum,"_top20_cont.jpg"), width = 30, height = 27, units = "cm")
}
...
summary(mod1) 
# Multiple R-squared:  0.04468,	Adjusted R-squared:  0.03457
# Sig results: PC11, PC4, PC3, PC6, ** almost: PC7

mod2 <- lm(merged_dat$globcog_random_slope~merged_dat$PC11+merged_dat$PC4+merged_dat$PC3++merged_dat$PC6++merged_dat$PC7)
summary(mod2) 
# Multiple R-squared:  0.0385,	Adjusted R-squared:  0.03598 

mod3 <- lm(merged_dat$globcog_random_slope~merged_dat$`IC_Alzheimer's_disease_h0.14431_n910`)
summary(mod3)
# Multiple R-squared:  0.02776,	Adjusted R-squared:  0.02725
...
summary(mod4)
# Multiple R-squared:  0.03792,	Adjusted R-squared:  0.03691 

mod5 <- lm(merged_dat$globcog_random_slope~merged_dat$`IC_Alzheimer's_disease_h0.14431_n910`+
                   merged_dat$PH_Dementias_h0.09265_n2229+
                   merged_dat$PC11+merged_dat$PC4+merged_dat$PC3+merged_dat$PC6+merged_dat$PC7)
summary(mod5)
# Multiple R-squared:  0.0442,	Adjusted R-squared:  0.04068

mod6 <- lm(merged_dat$globcog_random_slope~merged_dat$`IC_Alzheimer's_disease_h0.14431_n910`+
                   merged_dat$PH_Dementias_h0.09265_n2229+
                   merged_dat$IC_Delirium_not_induced_by_alcohol_and_other_psychoactive_substances_h0.12000_n1476)
summary(mod6)
# Multiple R-squared:  0.04136,	Adjusted R-squared:  0.03985  

mod7 <- lm(merged_dat$globcog_random_slope~merged_dat$`IC_Alzheimer's_disease_h0.14431_n910`+
                   merged_dat$PH_Dementias_h0.09265_n2229+
                   merged_dat$IC_Delirium_not_induced_by_alcohol_and_other_psychoactive_substances_h0.12000_n1476+
                   merged_dat$PC11+merged_dat$PC4+merged_dat$PC3+merged_dat$PC6+merged_dat$PC7)
summary(mod7)
# Multiple R-squared:  0.04503,	Adjusted R-squared:  0.04102 
...
ac <- function(x) {agnes(dist(t(matrix),method = "euclidean"),method = x)$ac}
map_dbl(m, ac)
# Euclidean: 0.4497289 0.4430195 0.4997926 0.8321551
...
ac <- function(x) {agnes(as.dist(1-cols.cor),method = x)$ac}
map_dbl(m, ac)
# Correlation: 0.6832907 0.6797741 0.7357786 0.9195320
