                ...
                for(method in c("scaled","centered")){
                                ...
                                if(method == "centered"){
                                                ...
                                                allres <- list(residuals=res.clean,
                                                               ...
                                                               res.ind=res.ind)
                                                if(isTRUE(no_mhc)){
                                                                saveRDS(allres,file=paste0("/Users/amink/OneDrive/Documents/Current Jobs/Masters Thesis/Code/Datasets/PRS_PRSice_No_MHC_Resid_PCA_Clust/Centered/", "PCAresults_",pval,".rds"))
                                                } else{
                                                                saveRDS(allres,file=paste0("/Users/amink/OneDrive/Documents/Current Jobs/Masters Thesis/Code/Datasets/PRS_PRSice_Resid_PCA_Clust/Centered/", "PCAresults_",pval,".rds"))         
                                                }
