---
title: "PCA plots of the PRSs matrices"
...
for(prs_matrix in names(results1)){
                jpeg(paste0("/Users/amink/OneDrive/Documents/Current Jobs/Masters Thesis/Code/Master_Thesis/Plots/PCA/Scree_Plot_",
                                            gsub("PCAresults_","",gsub(".rds","",prs_matrix)),".jpg"),
                                     width = 1200, height = 1500)
                fviz_eig(results1[[prs_matrix]]$pca,ncp = 40,main = paste0('Scree plot of the first 40 PCs for ',gsub(".rds","",prs_matrix)))
                dev.off()
}
``` 
